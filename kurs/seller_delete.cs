...
namespace kurs
{
    public partial class seller_delete : Form
    {
        ...
        private void del_button_Click(object sender, EventArgs e)
        {
            if (id_seller.Text != "")
            {
                ...
                SqlCommand check = new SqlCommand("select * from Orders where seller_id = @code", SQL_connection);
                ...
                if (!rd.HasRows)
                {
                    ...
                    {
                        SqlCommand cm1 = new SqlCommand("delete from Sellers where seller_id = @code", SQL_connection);
